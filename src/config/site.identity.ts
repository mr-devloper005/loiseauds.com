export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'loiseauds',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Loiseauds',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'loiseauds.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://loiseauds.com',
